...
\begin{quote}
    ...
    \begin{quote}
		...
		\begin{quote}
			...
			\TODO{minimale Abtastfrequenz}
			\TODO{einzelne Glieder}
		\end{quote}
    \end{quote}
    ...
    \begin{quote}
	   ...
	   \begin{equation*}
        	\begin{split}
        		U_{LSB} = \frac{(7V-(-7V))}{2^(10-1)} = \frac{7}{256}
        	\end{split}
        \end{equation*}
        
        Daraus ergibt sich, dass eine maximale Amplitude von $+7V$ um einen Wert von $256$ bzw. $10 Log(256) = 24 dB$
        gedämpft werden muss. \\
        An dem Frequenzgang sehen wir, dass alle Frequenzen die größer sind als $31kHz$ um mehr als $24 dB$ gedämpft
        werden. Aus diesem Wissen ergibt sich, dass die Abtastfrequenz $f_0 = 15,5Khz$ betragen soll.
