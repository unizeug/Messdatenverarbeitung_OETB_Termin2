...
\begin{quote}
    ...
    \begin{quote}
	   ...
	   \begin{equation*}
        ...
        Daraus ergibt sich, dass eine maximale Amplitude von $+7V$ um einen Wert von $\frac{1023}{2}$ bzw. $10
        Log(\frac{1023}{2}) = 27 dB$ gedämpft werden muss. \\
        An dem Frequenzgang sehen wir, dass alle Frequenzen die größer sind als $20kHz$ um mehr als $30 dB$ gedämpft
        werden. Aus diesem Wissen ergibt sich, dass die Abtastfrequenz $f_0 = 10Khz$ betragen soll.
